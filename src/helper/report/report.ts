...
/* =====================================
   LOAD ENV FILE
===================================== */
const envFileName = process.env.ENV ? `.env.${process.env.ENV}` : ".env.STG";
dotenv.config({
...
===================================== */
const projectName = process.env.PROJECT || "Sauce Demo Shopify";
const releaseVersion = process.env.RELEASE || "1.0.0";
const cycleName = process.env.CYCLE || "Smoke-1";
const baseUrl = process.env.BASEURL || "https://sauce-demo.myshopify.com";
